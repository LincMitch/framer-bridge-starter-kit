...
type Props = System.DialogTitleProps & {
  object: string[];
  externalObject: React.ReactNode;
  activeObjectIndex: number;
}

export class DialogTitle extends React.Component<Props> {
  render() {
    ...
    return <System.DialogTitle {...this.props} >{objectElements}</System.DialogTitle>
  }
