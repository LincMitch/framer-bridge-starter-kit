...
type Props = System.ImageListImageAspectContainerProps & {
  object: string[];
  externalObject: React.ReactNode;
  activeObjectIndex: number;
}

export class ImageListImageAspectContainer extends React.Component<Props> {
  render() {
    ...
    return <System.ImageListImageAspectContainer {...this.props} >{objectElements}</System.ImageListImageAspectContainer>
  }
