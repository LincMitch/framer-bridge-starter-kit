...
type Props = System.DialogButtonProps & {
  object: string[];
  externalObject: React.ReactNode;
  activeObjectIndex: number;
}

export class DialogButton extends React.Component<Props> {
  render() {
    ...
    return <System.DialogButton {...this.props} >{objectElements}</System.DialogButton>
  }
