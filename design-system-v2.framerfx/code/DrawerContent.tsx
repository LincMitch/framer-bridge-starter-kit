...
type Props = System.DrawerContentProps & {
  object: string[];
  externalObject: React.ReactNode;
  activeObjectIndex: number;
}

export class DrawerContent extends React.Component<Props> {
  render() {
    ...
    return <System.DrawerContent {...this.props} >{objectElements}</System.DrawerContent>
  }
