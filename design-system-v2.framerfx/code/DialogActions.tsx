...
type Props = System.DialogActionsProps & {
  object: string[];
  externalObject: React.ReactNode;
  activeObjectIndex: number;
}

export class DialogActions extends React.Component<Props> {
  render() {
    ...
    return <System.DialogActions {...this.props} >{objectElements}</System.DialogActions>
  }
