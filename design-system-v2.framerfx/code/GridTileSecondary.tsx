...
type Props = System.GridTileSecondaryProps & {
  object: string[];
  externalObject: React.ReactNode;
  activeObjectIndex: number;
}

export class GridTileSecondary extends React.Component<Props> {
  render() {
    ...
    return <System.GridTileSecondary {...this.props} >{objectElements}</System.GridTileSecondary>
  }
